...
{
    [DbContext(typeof(MusicBoxDbContext))]
    [Migration("20220312164126_Artist-Lastname-Update")]
    partial class ArtistLastnameUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicBox.Artists.Album", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("MusicBox.Artists.Artist", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MusicBox.Artists.Song", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MusicBox.Artists.SongDetail", b =>
                {
                    ...
                    b.Property<bool>("AlbumIsSingle")
                        .HasColumnType("bit");

                    b.Property<string>("AlbumName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("AlbumReleaseYear")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicBox.Artists.Album", b =>
                {
                    b.HasOne("MusicBox.Artists.Artist", null)
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("MusicBox.Artists.Song", b =>
                {
                    b.HasOne("MusicBox.Artists.Album", null)
                        .WithMany("Songs")
                        .HasForeignKey("AlbumId");

                    b.OwnsOne("MusicBox.Artists.SongMetaData", "MetaData", b1 =>
                        {
                            b1.Property<Guid>("SongId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("LengthInSeconds")
                                .HasColumnType("int")
